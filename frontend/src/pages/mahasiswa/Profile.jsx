...
export default function ProfileMahasiswa() {
  ...
  async function sendOtp() {
    try {
      ...
      // Setelah OTP dikirim, input tetap dikosongkan.
      // Mahasiswa harus mengetik sendiri kode OTP dari email.
      setOtp({
        code: '',
        new_password: '',
        confirm: '',
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-5 pb-16 lg:pb-0">
      <section className="card p-6 rounded-3xl overflow-hidden relative">
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center gap-4">
          <div className="w-16 h-16 rounded-3xl bg-primary/10 text-primary flex items-center justify-center shrink-0">
            <span className="material-symbols-rounded text-[34px]">account_circle</span>
          </div>
          ...
          <Link to="/mahasiswa/upload" className="btn-primary sm:ml-auto justify-center">
      ...
      <section className="card p-5 rounded-3xl">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Ganti sandi melalui OTP yang dikirim ke email akun atau memakai password lama.
            </p>
          </div>
          ...
          <div className="flex bg-gray-100 p-1 rounded-2xl text-sm font-bold">
            <button
              ...
              className={`px-3 py-2 rounded-xl ${mode === 'otp' ? 'bg-white text-primary shadow-card' : 'text-gray-500'}`}
            >
              OTP Email
            </button>
            ...
            <button
              ...
              className={`px-3 py-2 rounded-xl ${mode === 'manual' ? 'bg-white text-primary shadow-card' : 'text-gray-500'}`}
            >
              Password Lama
            </button>
          </div>
        ...
        {mode === 'otp' ? (
          <form onSubmit={changeByOtp} className="space-y-4" autoComplete="off">
            ...
            {otp.sent && (
              <div className="rounded-2xl bg-blue-50 border border-blue-200 px-4 py-3 text-sm text-blue-700">
                Kode OTP sudah dikirim ke email akun. Cek inbox atau folder spam.
              </div>
            )}
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  value={otp.code}
                  onChange={(e) => setOtp((f) => ({ ...f, code: e.target.value }))}
                  maxLength={6}
                  inputMode="numeric"
              ...
              <div>
                ...
                <input
                  type="password"
                  name="repota_new_password"
                  className="input"
                  value={otp.new_password}
                  onChange={(e) => setOtp((f) => ({ ...f, new_password: e.target.value }))}
              ...
              <div>
                ...
                <input
                  type="password"
                  name="repota_confirm_password"
                  className="input"
                  value={otp.confirm}
                  onChange={(e) => setOtp((f) => ({ ...f, confirm: e.target.value }))}
            ...
            <button disabled={loading || !otp.sent} className="btn-primary justify-center">
              <span className="material-symbols-rounded text-[18px]">lock_reset</span>
              Ubah Password dengan OTP
            </button>
          </form>
        ) : (
          <form onSubmit={changeManual} className="space-y-4" autoComplete="off">
            <div className="grid sm:grid-cols-3 gap-4">
              <div>
                <label className="label">
                ...
                <input
                  ...
                  onChange={(e) => setManual((f) => ({ ...f, current_password: e.target.value }))}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setManual((f) => ({ ...f, new_password: e.target.value }))}
                  autoComplete="new-password"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setManual((f) => ({ ...f, confirm: e.target.value }))}
                  autoComplete="new-password"
                />
              </div>
            </div>
      ...
      <section className="card p-5 rounded-3xl">
        ...
        <p className="text-sm text-gray-500 mt-2 leading-6">
          Jika email tidak menerima OTP, cek folder spam atau hubungi admin Program Studi Sistem Informasi melalui menu kontak di halaman guest.
        </p>
      </section>
    </div>
  );
